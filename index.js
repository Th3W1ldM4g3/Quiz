...
let textButton0 = document.getElementById("firstAnswer");
let textButton1 = document.getElementById("firstAnswer");
let textButton2 = document.getElementById("firstAnswer");
let textButton3 = document.getElementById("firstAnswer");
...
function temporario(){
    window.location.href = "https://www.geeksforgeeks.org/how-to-toggle-between-hiding-and-showing-an-element-using-javascript/"
}

document.getElementById("easy").addEventListener("click", startQuiz);
